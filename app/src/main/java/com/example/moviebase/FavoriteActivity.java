...
public class FavoriteActivity extends AppCompatActivity {
    ...
    private RecyclerView favorite_movies;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        favorite_movies = findViewById(R.id.recyclerView_favorite);
        favorite_movies.setLayoutManager(new GridLayoutManager(this,2));
        adapter = new MovieAdapter();
        favorite_movies.setAdapter(adapter);
        viewModel = new ViewModelProvider(this).get(MainViewModel.class);
        LiveData<List<FavouriteMovie>> favoriteMovies = viewModel.getFavouriteMovies();
        ...
        adapter.setOnPosterClickListener(new MovieAdapter.OnPosterClickListener() {
            ...
            public void onPosterClick(int position) {
                ...
                Intent intent = new Intent(FavoriteActivity.this,DetailInfoActivity.class);
