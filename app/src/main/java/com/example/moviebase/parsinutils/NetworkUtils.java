...
public class NetworkUtils {
    ...
    // Значения используемых параметров API
    private static final String API_KEY = "27093e8d8ffdb347d5a5590f36e2e162";
    private static final String LANGUAGE_VALUE = "ru-RU";
    private static final String SORT_BY_POPULARITY = "popularity.desc";
    private static final String SORT_BY_TOP_RATED = "vote_average.desc";
    private static final String MIN_VOTE_COUNT_VALUE = "1000";

    // Вариации сортировки фильмов
    ...
    public static URL buildURLToReviwes(int id) {
        URL result = null;
    ...
    // Получения JSON при подключении к API
    ...
    // Асинхронный класс для поключения к API
